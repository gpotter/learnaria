...
// Validation methodsvar $s = function (id) { return document.getElementById(id); }var $s = function (id) { return document.getElementById(id); }var $s = function (id) { return document.getElementById(id); }
