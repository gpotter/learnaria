...
var pluginName = "ik_sortable",
	...
	defaults = {
		'instructions': 'Use arrow keys to select the list item, ' + modifier + ' + arrow keys to move it to a new position.'
	};
	...
	Plugin.prototype.init = function () {
		...
		$('<div/>') // add div ele to be used with ara-describedby attrib. of the menu.	
			.text(plugin.options.instructions)
				.addClass('ik_readersonly') // hide ele from visual display
				.attr({
					'id': id + 'instructions',
					'aria-hidden' : 'true' //hide from screen readers for duplicate announcement
				})
				.appendTo($elem);
