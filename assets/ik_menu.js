;(function ( $, window, document, undefined ) {
	...
	var pluginName = 'ik_menu',
		defaults = {
			'instructions': 'Use keyboard arrow keys to navigate between menu items, the spacebar to expand a submenu, the escape key to close a submenu, and the enter key to activate menu items.'
		};
	...
	Plugin.prototype.init = function () {
		...
		plugin.menuitems = $elem.find('li') // setup menuitems
			...
			.each(function(i, el) {
				...
				//Generate aria-label from link text
				$me.attr({
					'role':'menuitem',
					'tabindex':-1,
